...
module.exports.getAllReviewByGradeId = async (id) => {
  const review = await db.query(`select "Review"."id", "Review"."gradeId", "Review"."gradeWant", "Review"."explaination", "Review"."final", "Review"."createdAt", "Grade"."studentId","Grade"."fullName", "Grade"."point", "Grade"."AssignmentId", "Grade"."ClassId", "Assignment"."name", "Assignment"."point" as "AssignmentPoint"
...
module.exports.refuseReview = async (reviewId) => {
  await Review.update(
    {
      final: true,
    },
